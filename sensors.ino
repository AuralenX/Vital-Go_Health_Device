...
// const unsigned long STEP_DEBOUNCE = 600; 
...
//   // Initialize I2C with proper pullups
//   Wire.begin();
//   Wire.setClock(100000);  // START WITH 100kHz, not 400kHz
//   delay(100);
  
//   // 1. Initialize BMP280 FIRST (most sensitive)
//   Serial.print("Initializing BMP280 at 0x");
...
//   }
//   delay(200);  // IMPORTANT: Give bus time to settle
  
//   // 2. Initialize MPU6050
//   Serial.print("Initializing MPU6050 at 0x");
...
//   // 3. Initialize MAX30102 LAST (can be problematic)
//   Serial.print("Initializing MAX30102 at 0x");
//   Serial.println(MAX30102_ADDRESS, HEX);
  
//   // Try multiple times for MAX30102
//   bool maxFound = false;
...
//     byte ledBrightness = 0x1F;  // REDUCE brightness for stability
//     byte sampleAverage = 4;
//     byte ledMode = 2;           // Try mode 2 (RED only) first
//     int sampleRate = 100;       // SLOWER sample rate
//     int pulseWidth = 411;
//     int adcRange = 4096;
    
//     particleSensor.setup(ledBrightness, sampleAverage, ledMode, 
//                          sampleRate, pulseWidth, adcRange);
//     particleSensor.setPulseAmplitudeRed(0x1F);  // Reduced power
//     particleSensor.setPulseAmplitudeGreen(0);
    
//     Serial.println("✓ MAX30102 OK");
//     Serial.print("IR LED test: ");
//     long irTest = particleSensor.getIR();
//     Serial.println(irTest);
//   } else {
//     Serial.println("✗ MAX30102 FAILED after 3 attempts");
//     // Try alternative address
//     Serial.println("Trying alternative address 0x5A...");
//     if (particleSensor.begin(Wire, I2C_SPEED_STANDARD, 0x5A)) {
//       max30102Detected = true;
//       Serial.println("✓ MAX30102 found at 0x5A!");
//     }
//   }
...
//   // 5. Increase speed AFTER all sensors initialized
//   if (bmp280Detected || mpu6050Detected || max30102Detected) {
//     Wire.setClock(400000);  // Now increase to 400kHz
//     Serial.println("I2C speed increased to 400kHz");
//   }
// }
...
//   if (accelMagnitude > 10.0 && !fallDetected) {  
//     fallDetected = true;
//     fallTime = millis();
...
//   Serial.println(bloodPressureSystolic);
//   Serial.print("BloodPressureDiastolic: ");
//   Serial.println(bloodPressureDiastolic);
